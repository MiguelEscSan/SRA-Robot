...
def find_obstacle(movement, ultrasonic_sensor, down_threshold=10, up_threshold=80, step_angle=5, max_angle=60, only_left=True):
    """
    ...
    while True:
        ...
        if current_distance is None or current_distance > min_obstacle_distance or math.trunc(current_distance) > math.trunc(best_distance) + threshold:
            ...
            _, best_angle = find_obstacle(
                movement, ultrasonic_sensor, down_threshold=best_distance
            )
